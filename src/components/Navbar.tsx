                        ...
                        >
                            ...
                            {menuItems.map((item) => (
                                <motion.button
                                    ...
                                    onClick={() => handleTabClick(item.tab, item.path)}
                                    className={`text-3xl font-bold text-black hover:text-${item.color} transition-colors`}
                            ...
                            <motion.button
                                ...
                                className="text-3xl font-bold text-pastel-yellow hover:text-yellow-600 transition-colors"
                            >
                                {t.join_us}
                            </motion.button>
                            ...
                            <motion.button
                                ...
                                className="text-3xl font-bold text-pastel-mint hover:text-green-600 transition-colors"
                            >
                                Be a Coach
                            </motion.button>
                            ...
                            {isLoggedIn && user ? (
                                <>
                                    <motion.div
                                        ...
                                        className="flex flex-col items-center gap-2 py-4 px-6 bg-gray-50 rounded-xl border-2 border-black cursor-pointer hover:bg-gray-100 transition-colors mt-2"
                                    >
                                        <div className="w-14 h-14 bg-pastel-acid rounded-full border-2 border-black flex items-center justify-center overflow-hidden">
                                            {user.avatar_url ? (
                                                <img src={user.avatar_url} alt={user.name} className="w-full h-full object-cover" />
                                            ) : (
                                    ...
                                    <motion.button
                                        ...
                                        className="text-2xl font-bold text-red-500 hover:text-red-700 transition-colors flex items-center gap-2 mt-2"
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                    >
