...
import { ArrowRight, Check, Sparkles, TrendingUp, Calendar, CreditCard, Users, Trophy } from "lucide-react"
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-50/90 backdrop-blur-sm overflow-hidden">
            ...
            <motion.div
                ...
                className="bg-white w-full max-w-6xl h-[85vh] max-h-[800px] rounded-3xl border-2 border-black shadow-hard-lg overflow-hidden flex flex-col md:flex-row"
            >
                {/* Left Side - Content */}
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col h-full relative z-10">
                    ...
                    <div className="flex-1 overflow-y-auto min-h-0 flex flex-col py-4 scrollbar-thin pr-2">
                    ...
                    <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100 shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                onClick={nextStep}
                                className="bg-black text-white px-6 py-3 rounded-xl font-bold border-2 border-transparent hover:bg-white hover:text-black hover:border-black transition-all shadow-hard-sm flex items-center gap-2"
                            >
                                {step === 2 ? "Get Started" : "Continue"} <ArrowRight className="w-4 h-4" />
                            </button>
                        </div>
                    </div>
