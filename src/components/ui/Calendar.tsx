...
// import "react-day-picker/dist/style.css"; // We will style manually with Tailwind
    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-100 rounded-md transition-colors flex items-center justify-center cursor-pointer"
                ),
